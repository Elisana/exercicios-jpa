...
public class NovotioSobrinho {
	public static void main(String[] args) {
		//exemplo de relação bidirecional
		
		Tio tia1 = new Tio("Susana");
		Tio tia2 = new Tio("Fernando");
		
		Sobrinho sobrinho1 = new Sobrinho("Beatriz");
		Sobrinho sobrinho2 = new Sobrinho("Carolina");
