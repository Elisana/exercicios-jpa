...
public class Filme {
	...
	@JoinTable(
			 ...
			 ) //especifica o nome da tabela que será criada para junção dos dados nXn 
	...
	public void adicionarAtor(Ator ator) {
		//se o objeto ator não for nulo, e o ator não existir na lista existente
		if(ator != null && !getAtores().contains(ator)) {
			getAtores().add(ator);
			
			//Se o filme atual não está na lsita de filmes do ator
